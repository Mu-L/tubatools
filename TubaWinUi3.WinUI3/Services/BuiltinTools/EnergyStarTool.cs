...
public sealed class EnergyStarTool : IBuiltinTool
{
    ...
    public string Name => LocalizationService.L("Builtin_energy-star_Name", "后台节流省电神器");
    public string Description => LocalizationService.L("Builtin_energy-star_Desc", "通过 Windows 11 效率模式 (EcoQoS) 节流后台进程以省电降温, 前台应用保持流畅 (基于 Energy Star X 内核)。");
    public string Glyph => "\uE83F";
